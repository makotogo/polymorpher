...
public class App {
  ...
  public String processGreeting(Greeter greeter) {
    String ret = greeter.greet();
    log.info("Greeter (" + greeter.getClass().getName() + "): " + ret);
    return ret;
  }
  ...
  public String processGreeting(Person person) {
    String ret = person.greet("I'm a Person!");
    log.info("Person (" + person.getClass().getName() + "): " + ret);
    return ret;
  }
  ...
  public String processGreeting(Employee employee) {
    String ret = employee.greet("I'm an Employee!");
    log.info(
        "Employee (" + employee.getClass().getName() + "): " + ret);
    return ret;
  }
  ...
  public String processComplaint(Complainer complainer) {
    String ret = complainer.complain();
    log.info("Complainer ( " + complainer.getClass().getName() + "): " + ret);
    return ret;
  }
  ...
  public String processName(NamedEntity namedEntity) {
    String ret = namedEntity.name();
    log.info("NamedEntity.name = '" + ret + "'");
    return ret;
  }
