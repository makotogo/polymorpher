 ...
 * of performing some type of complaint.
 * <p>
...
public interface Complainer {
  ...
  /**
   * Provide a complaint. Will be different for every top-level
   * implementation.
   * 
   * @return String - the complaint provided by the implementation.
   */
